...
class CallParkApi:
    ...
    @validate_call
    def v1_account_account_id_parkedcall_get(
        self,
        ...
        _param = self._v1_account_account_id_parkedcall_get_serialize(
    ...
    @validate_call
    def v1_account_account_id_parkedcall_get_with_http_info(
        self,
        account_id: Annotated[StrictStr, Field(description="Account ID, 32 alpha numeric")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def v1_account_account_id_parkedcall_get_without_preload_content(
        self,
        account_id: Annotated[StrictStr, Field(description="Account ID, 32 alpha numeric")],
        _request_timeout: Union[
            None,
    ...
    def _v1_account_account_id_parkedcall_get_serialize(
        self,
        account_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/account/{accountID}/parkedcall',
