...
class DataApi:
    ...
    def v1_account_account_id_cdr_get(
        self,
        account_id: Annotated[StrictStr, Field(description="Account ID, 32 alpha numeric")],
        page_size: Annotated[Optional[StrictStr], Field(description="Page size (Maximum number of results to display per page)")] = None,
        start_key: Annotated[Optional[StrictStr], Field(description="Start key (Starting offset for displaying results)")] = None,
        created_from: Annotated[Optional[StrictStr], Field(description="For displaying records which are created on or after this timestamp (Supported timestamp formats: iso 8601, unix time in seconds or milliseconds or microseconds or nanoseconds)")] = None,
        created_to: Annotated[Optional[StrictStr], Field(description="For displaying records which are created on or before this timestamp (Supported timestamp formats: iso 8601, unix time in seconds or milliseconds or microseconds or nanoseconds)")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param account_id: Account ID, 32 alpha numeric (required)
        :type account_id: str
        :param page_size: Page size (Maximum number of results to display per page)
        :type page_size: str
        :param start_key: Start key (Starting offset for displaying results)
        :type start_key: str
        :param created_from: For displaying records which are created on or after this timestamp (Supported timestamp formats: iso 8601, unix time in seconds or milliseconds or microseconds or nanoseconds)
        :type created_from: str
        :param created_to: For displaying records which are created on or before this timestamp (Supported timestamp formats: iso 8601, unix time in seconds or milliseconds or microseconds or nanoseconds)
        :type created_to: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
