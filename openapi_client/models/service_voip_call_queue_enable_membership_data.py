...
class ServiceVOIPCallQueueEnableMembershipData(BaseModel):
    """
    ServiceVOIPCallQueueEnableMembershipData
    """ # noqa: E501
    accept_charges: StrictBool
    __properties: ClassVar[List[str]] = ["accept_charges"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accept_charges": obj.get("accept_charges")
        })
        return _obj
