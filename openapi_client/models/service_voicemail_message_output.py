...
class ServiceVoicemailMessageOutput(BaseModel):
    """
    ...
    media_id: Optional[StrictStr] = None
    succeeded: Optional[List[StrictStr]] = None
    timestamp: Optional[StrictInt] = None
    to: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["call_id", "caller_id_name", "caller_id_number", "folder", "from", "length", "media_id", "succeeded", "timestamp", "to"]
