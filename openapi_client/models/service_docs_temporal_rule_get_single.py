...
class ServiceDocsTemporalRuleGetSingle(BaseModel):
    """
    ServiceDocsTemporalRuleGetSingle
    """ # noqa: E501
    data: Optional[ServiceTemporalRuleOutputFull] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceTemporalRuleOutputFull.from_dict(obj["data"]) if obj.get("data") is not None else None,
