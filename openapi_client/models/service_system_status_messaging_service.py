...
class ServiceSystemStatusMessagingService(BaseModel):
    """
    ServiceSystemStatusMessagingService
    """ # noqa: E501
    messaging_server: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["messaging_server"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "messaging_server": obj.get("messaging_server")
        })
        return _obj
