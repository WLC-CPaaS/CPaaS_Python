...
class ServiceDocsAdminUserDelete(BaseModel):
    """
    ServiceDocsAdminUserDelete
    """ # noqa: E501
    data: Optional[ServiceAdminUserDeleteOutput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceAdminUserDeleteOutput.from_dict(obj["data"]) if obj.get("data") is not None else None,
