...
class ResponseProvisionError(BaseModel):
    """
    ...
    request_id: Optional[StrictStr] = Field(default=None, description="Request ID")
    status_code: Optional[StrictInt] = Field(default=None, description="HTTP response status code")
    __properties: ClassVar[List[str]] = ["error_code", "errors", "message", "request_id", "status_code"]
