...
class ServiceDocGroupGetSingle(BaseModel):
    """
    ServiceDocGroupGetSingle
    """ # noqa: E501
    data: Optional[ServiceGroupOutputFull] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceGroupOutputFull.from_dict(obj["data"]) if obj.get("data") is not None else None,
