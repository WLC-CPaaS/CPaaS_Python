...
class ServiceChannelRunMetaflowData(BaseModel):
    """
    ServiceChannelRunMetaflowData
    """ # noqa: E501
    children: Optional[Dict[str, ServiceChannelRunMetaflowData]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "children": dict(
                (_k, ServiceChannelRunMetaflowData.from_dict(_v))
...
ServiceChannelRunMetaflowData.model_rebuild(raise_errors=False)
