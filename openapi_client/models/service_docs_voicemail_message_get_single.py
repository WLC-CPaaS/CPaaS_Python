...
class ServiceDocsVoicemailMessageGetSingle(BaseModel):
    """
    ServiceDocsVoicemailMessageGetSingle
    """ # noqa: E501
    data: Optional[ServiceVoicemailMessageOutput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceVoicemailMessageOutput.from_dict(obj["data"]) if obj.get("data") is not None else None,
