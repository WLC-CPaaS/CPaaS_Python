...
class ServiceDocsSystemStatusGetSingle(BaseModel):
    """
    ServiceDocsSystemStatusGetSingle
    """ # noqa: E501
    data: Optional[ServiceSystemStatusOutput] = None
    ...
    system_status: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["data", "request_id", "status_code", "system_status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceSystemStatusOutput.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "request_id": obj.get("request_id"),
            "status_code": obj.get("status_code"),
            "system_status": obj.get("system_status")
        })
        return _obj
