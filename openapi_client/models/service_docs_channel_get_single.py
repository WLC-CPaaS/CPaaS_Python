...
class ServiceDocsChannelGetSingle(BaseModel):
    """
    ServiceDocsChannelGetSingle
    """ # noqa: E501
    data: Optional[ServiceChannelOutput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceChannelOutput.from_dict(obj["data"]) if obj.get("data") is not None else None,
