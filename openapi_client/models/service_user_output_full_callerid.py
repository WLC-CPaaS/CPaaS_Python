...
class ServiceUserOutputFullCallerid(BaseModel):
    """
    ServiceUserOutputFullCallerid
    """ # noqa: E501
    emergency: Optional[ServiceUserOutputFullCalleridEmergency] = None
    external: Optional[ServiceUserOutputFullCalleridExternal] = None
    internal: Optional[ServiceUserOutputFullCalleridInternal] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "emergency": ServiceUserOutputFullCalleridEmergency.from_dict(obj["emergency"]) if obj.get("emergency") is not None else None,
            "external": ServiceUserOutputFullCalleridExternal.from_dict(obj["external"]) if obj.get("external") is not None else None,
            "internal": ServiceUserOutputFullCalleridInternal.from_dict(obj["internal"]) if obj.get("internal") is not None else None
        })
        return _obj
