...
class ServiceDocsE911RemoveLocationOutput(BaseModel):
    """
    ServiceDocsE911RemoveLocationOutput
    """ # noqa: E501
    data: Optional[ServiceE911RemoveLocationOutput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceE911RemoveLocationOutput.from_dict(obj["data"]) if obj.get("data") is not None else None,
