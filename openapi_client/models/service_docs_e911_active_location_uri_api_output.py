...
class ServiceDocsE911ActiveLocationURIApiOutput(BaseModel):
    """
    ServiceDocsE911ActiveLocationURIApiOutput
    """ # noqa: E501
    data: Optional[ServiceE911LocationURI] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceE911LocationURI.from_dict(obj["data"]) if obj.get("data") is not None else None,
