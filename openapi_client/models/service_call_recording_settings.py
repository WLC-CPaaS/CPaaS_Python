...
class ServiceCallRecordingSettings(BaseModel):
    """
    ServiceCallRecordingSettings
    """ # noqa: E501
    any: Optional[ServiceCallRecordingSource] = None
    inbound: Optional[ServiceCallRecordingSource] = None
    outbound: Optional[ServiceCallRecordingSource] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "any": ServiceCallRecordingSource.from_dict(obj["any"]) if obj.get("any") is not None else None,
            "inbound": ServiceCallRecordingSource.from_dict(obj["inbound"]) if obj.get("inbound") is not None else None,
            "outbound": ServiceCallRecordingSource.from_dict(obj["outbound"]) if obj.get("outbound") is not None else None
        })
        return _obj
