...
class ServiceCampaignPhoneNumberOutput(BaseModel):
    """
    ServiceCampaignPhoneNumberOutput
    """ # noqa: E501
    telephone_numbers: Optional[List[StrictStr]] = None
    total_count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["telephone_numbers", "total_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "telephone_numbers": obj.get("telephone_numbers"),
