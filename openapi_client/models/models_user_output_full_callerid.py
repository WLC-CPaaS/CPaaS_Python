...
class ModelsUserOutputFullCallerid(BaseModel):
    """
    ModelsUserOutputFullCallerid
    """ # noqa: E501
    emergency: Optional[ModelsUserOutputFullCalleridEmergency] = None
    external: Optional[ModelsUserOutputFullCalleridExternal] = None
    internal: Optional[ModelsUserOutputFullCalleridInternal] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "emergency": ModelsUserOutputFullCalleridEmergency.from_dict(obj["emergency"]) if obj.get("emergency") is not None else None,
            "external": ModelsUserOutputFullCalleridExternal.from_dict(obj["external"]) if obj.get("external") is not None else None,
            "internal": ModelsUserOutputFullCalleridInternal.from_dict(obj["internal"]) if obj.get("internal") is not None else None
        })
        return _obj
