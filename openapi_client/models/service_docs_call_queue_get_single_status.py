...
class ServiceDocsCallQueueGetSingleStatus(BaseModel):
    """
    ServiceDocsCallQueueGetSingleStatus
    """ # noqa: E501
    data: Optional[ServiceCallQueueStatusOutput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceCallQueueStatusOutput.from_dict(obj["data"]) if obj.get("data") is not None else None,
