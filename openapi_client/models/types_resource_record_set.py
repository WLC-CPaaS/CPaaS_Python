...
class TypesResourceRecordSet(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TypesResourceRecordSet from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of alias_target
        if self.alias_target:
            _dict['aliasTarget'] = self.alias_target.to_dict()
        # override the default output from pydantic by calling `to_dict()` of cidr_routing_config
        if self.cidr_routing_config:
            _dict['cidrRoutingConfig'] = self.cidr_routing_config.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of geo_proximity_location
        if self.geo_proximity_location:
            _dict['geoProximityLocation'] = self.geo_proximity_location.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TypesResourceRecordSet from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "aliasTarget": TypesAliasTarget.from_dict(obj["aliasTarget"]) if obj.get("aliasTarget") is not None else None,
            "cidrRoutingConfig": TypesCidrRoutingConfig.from_dict(obj["cidrRoutingConfig"]) if obj.get("cidrRoutingConfig") is not None else None,
            "failover": obj.get("failover"),
            "geoLocation": TypesGeoLocation.from_dict(obj["geoLocation"]) if obj.get("geoLocation") is not None else None,
            "geoProximityLocation": TypesGeoProximityLocation.from_dict(obj["geoProximityLocation"]) if obj.get("geoProximityLocation") is not None else None,
            "healthCheckId": obj.get("healthCheckId"),
            "multiValueAnswer": obj.get("multiValueAnswer"),
            "name": obj.get("name"),
            "region": obj.get("region"),
            "resourceRecords": [TypesResourceRecord.from_dict(_item) for _item in obj["resourceRecords"]] if obj.get("resourceRecords") is not None else None,
            "setIdentifier": obj.get("setIdentifier"),
            "trafficPolicyInstanceId": obj.get("trafficPolicyInstanceId"),
            "ttl": obj.get("ttl"),
            "type": obj.get("type"),
