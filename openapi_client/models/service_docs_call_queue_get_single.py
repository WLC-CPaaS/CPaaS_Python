...
class ServiceDocsCallQueueGetSingle(BaseModel):
    """
    ServiceDocsCallQueueGetSingle
    """ # noqa: E501
    data: Optional[ServiceCallQueueOutputFull] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceCallQueueOutputFull.from_dict(obj["data"]) if obj.get("data") is not None else None,
