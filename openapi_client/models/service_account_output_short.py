...
class ServiceAccountOutputShort(BaseModel):
    """
    ServiceAccountOutputShort
    """ # noqa: E501
    descendants_count: Optional[StrictInt] = None
    flags: Optional[List[StrictStr]] = None
    id: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    realm: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["descendants_count", "flags", "id", "name", "realm"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "descendants_count": obj.get("descendants_count"),
            "flags": obj.get("flags"),
            "id": obj.get("id"),
            "name": obj.get("name"),
            "realm": obj.get("realm")
