...
class ServiceVOIPCallQueueAddEditData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["agent_wrapup_time", "features", "force_away_on_reject", "name", "queue_router", "queue_type", "ring_timeout", "tick_time"]
