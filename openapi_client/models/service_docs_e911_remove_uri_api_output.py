...
class ServiceDocsE911RemoveURIApiOutput(BaseModel):
    """
    ServiceDocsE911RemoveURIApiOutput
    """ # noqa: E501
    data: Optional[ServiceRemoveURIApiOutput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceRemoveURIApiOutput.from_dict(obj["data"]) if obj.get("data") is not None else None,
