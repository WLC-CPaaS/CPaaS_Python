...
class ServiceQueueRecipientOutput(BaseModel):
    """
    ...
    recipient: Optional[ServiceQueueRecipientOutputRecipient] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "recipient": ServiceQueueRecipientOutputRecipient.from_dict(obj["recipient"]) if obj.get("recipient") is not None else None,
            "roles": obj.get("roles")
        })
        return _obj
