...
class ServiceDocsCallQueueGetRoles(BaseModel):
    """
    ServiceDocsCallQueueGetRoles
    """ # noqa: E501
    data: Optional[ServiceCallQueueRolesOutput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceCallQueueRolesOutput.from_dict(obj["data"]) if obj.get("data") is not None else None,
