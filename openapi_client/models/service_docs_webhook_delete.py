...
class ServiceDocsWebhookDelete(BaseModel):
    """
    ServiceDocsWebhookDelete
    """ # noqa: E501
    data: Optional[ServiceWebhookDeleteOutput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceWebhookDeleteOutput.from_dict(obj["data"]) if obj.get("data") is not None else None,
