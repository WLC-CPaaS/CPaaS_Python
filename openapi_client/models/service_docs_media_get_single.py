...
class ServiceDocsMediaGetSingle(BaseModel):
    """
    ServiceDocsMediaGetSingle
    """ # noqa: E501
    data: Optional[ServiceMediaOutputFull] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceMediaOutputFull.from_dict(obj["data"]) if obj.get("data") is not None else None,
