...
class ModelsTemplate(BaseModel):
    """
    ModelsTemplate
    """ # noqa: E501
    ...
    firmware_id: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["brand_name", "created_at", "family_name", "firmware_id", "firmware_version", "id", "is_active", "model_name", "template_name", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "firmware_id": obj.get("firmware_id"),
