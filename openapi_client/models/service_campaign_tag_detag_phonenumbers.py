...
class ServiceCampaignTagDetagPhonenumbers(BaseModel):
    """
    ServiceCampaignTagDetagPhonenumbers
    """ # noqa: E501
    detag: Optional[StrictBool] = None
    phone_numbers: List[StrictStr]
    __properties: ClassVar[List[str]] = ["detag", "phone_numbers"]
