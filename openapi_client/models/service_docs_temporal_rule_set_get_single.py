...
class ServiceDocsTemporalRuleSetGetSingle(BaseModel):
    """
    ServiceDocsTemporalRuleSetGetSingle
    """ # noqa: E501
    data: Optional[ServiceTemporalRuleSetOutputFull] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceTemporalRuleSetOutputFull.from_dict(obj["data"]) if obj.get("data") is not None else None,
