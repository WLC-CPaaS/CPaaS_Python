...
class ServiceDocsCampaignTagDetagPhonenumbersOutput(BaseModel):
    """
    ServiceDocsCampaignTagDetagPhonenumbersOutput
    """ # noqa: E501
    data: Optional[ServiceCampaignTagDetagPhonenumbersOutput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceCampaignTagDetagPhonenumbersOutput.from_dict(obj["data"]) if obj.get("data") is not None else None,
