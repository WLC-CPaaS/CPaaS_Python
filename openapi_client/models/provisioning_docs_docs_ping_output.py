...
class ProvisioningDocsDocsPingOutput(BaseModel):
    """
    ProvisioningDocsDocsPingOutput
    """ # noqa: E501
    data: Optional[ProvisioningDocsDocsPingOutputData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ProvisioningDocsDocsPingOutputData.from_dict(obj["data"]) if obj.get("data") is not None else None,
