...
class V1AccountAccountidDnsrecordGet200Response(BaseModel):
    """
    V1AccountAccountidDnsrecordGet200Response
    """ # noqa: E501
    data: Optional[TypesResourceRecordSet] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": TypesResourceRecordSet.from_dict(obj["data"]) if obj.get("data") is not None else None,
