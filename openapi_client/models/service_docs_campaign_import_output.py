...
class ServiceDocsCampaignImportOutput(BaseModel):
    """
    ServiceDocsCampaignImportOutput
    """ # noqa: E501
    data: Optional[ServiceCampaignImportOutput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceCampaignImportOutput.from_dict(obj["data"]) if obj.get("data") is not None else None,
