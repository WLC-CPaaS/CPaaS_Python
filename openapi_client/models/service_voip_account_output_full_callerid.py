...
class ServiceVOIPAccountOutputFullCallerid(BaseModel):
    """
    ServiceVOIPAccountOutputFullCallerid
    """ # noqa: E501
    emergency: Optional[ServiceAccountOutputFullCalleridEmergency] = None
    external: Optional[ServiceAccountOutputFullCalleridExternal] = None
    internal: Optional[ServiceAccountOutputFullCalleridInternal] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of emergency
        if self.emergency:
            _dict['emergency'] = self.emergency.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "emergency": ServiceAccountOutputFullCalleridEmergency.from_dict(obj["emergency"]) if obj.get("emergency") is not None else None,
            "external": ServiceAccountOutputFullCalleridExternal.from_dict(obj["external"]) if obj.get("external") is not None else None,
            "internal": ServiceAccountOutputFullCalleridInternal.from_dict(obj["internal"]) if obj.get("internal") is not None else None
        })
        return _obj
