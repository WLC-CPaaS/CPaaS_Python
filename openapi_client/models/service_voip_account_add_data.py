...
class ServiceVOIPAccountAddData(BaseModel):
    """
    ...
    realm: Optional[Annotated[str, Field(min_length=3, strict=True, max_length=50)]] = None
    timezone: Annotated[str, Field(min_length=5, strict=True, max_length=32)]
    __properties: ClassVar[List[str]] = ["caller_id", "do_not_disturb", "music_on_hold", "name", "realm", "timezone"]
