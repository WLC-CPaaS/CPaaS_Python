...
class ServiceMediaOutputShort(BaseModel):
    """
    ServiceMediaOutputShort
    """ # noqa: E501
    id: Optional[StrictStr] = None
    is_prompt: Optional[StrictBool] = None
    language: Optional[StrictStr] = None
    media_source: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "is_prompt", "language", "media_source", "name"]
