...
class ServiceDocsCallflowGetAll(BaseModel):
    """
    ServiceDocsCallflowGetAll
    """ # noqa: E501
    data: Optional[ServiceCallflowOutputShort] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceCallflowOutputShort.from_dict(obj["data"]) if obj.get("data") is not None else None,
