...
class ServiceVOIPChannelRunMetaflowData(BaseModel):
    """
    ServiceVOIPChannelRunMetaflowData
    """ # noqa: E501
    children: Optional[Dict[str, ServiceVOIPChannelRunMetaflowData]] = None
    ...
    def module_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['transfer', 'hold']):
            raise ValueError("must be one of enum values ('transfer', 'hold')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "children": dict(
                (_k, ServiceVOIPChannelRunMetaflowData.from_dict(_v))
...
ServiceVOIPChannelRunMetaflowData.model_rebuild(raise_errors=False)
