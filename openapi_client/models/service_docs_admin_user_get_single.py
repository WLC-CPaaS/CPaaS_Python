...
class ServiceDocsAdminUserGetSingle(BaseModel):
    """
    ServiceDocsAdminUserGetSingle
    """ # noqa: E501
    data: Optional[ServiceAdminUserOutput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceAdminUserOutput.from_dict(obj["data"]) if obj.get("data") is not None else None,
