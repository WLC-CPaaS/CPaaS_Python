...
class ServiceDocsE911ValidateLocationOutput(BaseModel):
    """
    ServiceDocsE911ValidateLocationOutput
    """ # noqa: E501
    data: Optional[ServiceE911ValidateLocationOutput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceE911ValidateLocationOutput.from_dict(obj["data"]) if obj.get("data") is not None else None,
