...
class ServiceQueueRecipientOutputFull(BaseModel):
    """
    ...
    recipient: Optional[ServiceQueueRecipientOutputFullRecipient] = None
    roles: Optional[Dict[str, StrictStr]] = None
    __properties: ClassVar[List[str]] = ["display_name", "id", "name", "recipient", "roles"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "recipient": ServiceQueueRecipientOutputFullRecipient.from_dict(obj["recipient"]) if obj.get("recipient") is not None else None,
            "roles": obj.get("roles")
        })
        return _obj
