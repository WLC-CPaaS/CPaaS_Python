...
class ProvisioningDocsDocsFamilyOutputSingle(BaseModel):
    """
    ProvisioningDocsDocsFamilyOutputSingle
    """ # noqa: E501
    data: Optional[ModelsFamily] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ModelsFamily.from_dict(obj["data"]) if obj.get("data") is not None else None,
