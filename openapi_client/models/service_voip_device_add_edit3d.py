...
class ServiceVOIPDeviceAddEdit3d(BaseModel):
    """
    ServiceVOIPDeviceAddEdit3d
    """ # noqa: E501
    audio: Optional[ServiceVOIPDeviceAddEdit5] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "audio": ServiceVOIPDeviceAddEdit5.from_dict(obj["audio"]) if obj.get("audio") is not None else None
        })
        return _obj
