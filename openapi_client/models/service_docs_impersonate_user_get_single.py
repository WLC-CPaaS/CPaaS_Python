...
class ServiceDocsImpersonateUserGetSingle(BaseModel):
    """
    ServiceDocsImpersonateUserGetSingle
    """ # noqa: E501
    data: Optional[ServiceImpersonateUserOutputFull] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceImpersonateUserOutputFull.from_dict(obj["data"]) if obj.get("data") is not None else None,
