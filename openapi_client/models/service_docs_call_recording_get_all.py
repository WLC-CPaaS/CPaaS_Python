...
class ServiceDocsCallRecordingGetAll(BaseModel):
    """
    ServiceDocsCallRecordingGetAll
    """ # noqa: E501
    data: Optional[List[ServiceCallRecordingOutput]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ServiceCallRecordingOutput.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
