...
class TypesAliasTarget(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TypesAliasTarget from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TypesAliasTarget from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "evaluateTargetHealth": obj.get("evaluateTargetHealth"),
            "hostedZoneId": obj.get("hostedZoneId")
        })
        return _obj
