...
class ServiceVOIPStorageAddEditData(BaseModel):
    """
    ...
    plan: Optional[ServiceStoragePlan] = None
    __properties: ClassVar[List[str]] = ["attachments", "connections", "id", "plan"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "plan": ServiceStoragePlan.from_dict(obj["plan"]) if obj.get("plan") is not None else None
        })
        return _obj
