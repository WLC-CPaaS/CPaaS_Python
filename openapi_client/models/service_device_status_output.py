...
class ServiceDeviceStatusOutput(BaseModel):
    """
    ServiceDeviceStatusOutput
    """ # noqa: E501
    device_id: Optional[StrictStr] = None
    registered: Optional[StrictBool] = None
    registrable: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["device_id", "registered", "registrable"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "registrable": obj.get("registrable")
        })
        return _obj
