...
class ServiceE911ValidateLocationOutput(BaseModel):
    """
    ServiceE911ValidateLocationOutput
    """ # noqa: E501
    location: Optional[ServiceE911LocationOutput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "location": ServiceE911LocationOutput.from_dict(obj["location"]) if obj.get("location") is not None else None
        })
        return _obj
