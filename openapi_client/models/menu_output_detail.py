...
class MenuOutputDetail(BaseModel):
    """
    MenuOutputDetail
    """ # noqa: E501
    data: Optional[MenuOutputDetailData] = Field(default=None, description="Data Payload")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": MenuOutputDetailData.from_dict(obj["data"]) if obj.get("data") is not None else None,
