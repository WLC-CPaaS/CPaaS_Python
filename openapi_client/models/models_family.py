...
class ModelsFamily(BaseModel):
    ...
    timezone_format_id: Optional[StrictInt] = None
    updated_at: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["brand_name", "created_at", "family_name", "id", "is_active", "timezone_format_id", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "timezone_format_id": obj.get("timezone_format_id"),
