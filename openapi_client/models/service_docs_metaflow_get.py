...
class ServiceDocsMetaflowGet(BaseModel):
    """
    ServiceDocsMetaflowGet
    """ # noqa: E501
    data: Optional[ServiceMetaflowOutput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceMetaflowOutput.from_dict(obj["data"]) if obj.get("data") is not None else None,
