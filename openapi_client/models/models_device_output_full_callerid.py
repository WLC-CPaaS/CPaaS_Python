...
class ModelsDeviceOutputFullCallerid(BaseModel):
    """
    ModelsDeviceOutputFullCallerid
    """ # noqa: E501
    emergency: Optional[ModelsDeviceOutputFullCalleridEmergency] = None
    external: Optional[ModelsDeviceOutputFullCalleridExternal] = None
    internal: Optional[ModelsDeviceOutputFullCalleridInternal] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "emergency": ModelsDeviceOutputFullCalleridEmergency.from_dict(obj["emergency"]) if obj.get("emergency") is not None else None,
            "external": ModelsDeviceOutputFullCalleridExternal.from_dict(obj["external"]) if obj.get("external") is not None else None,
            "internal": ModelsDeviceOutputFullCalleridInternal.from_dict(obj["internal"]) if obj.get("internal") is not None else None
        })
        return _obj
