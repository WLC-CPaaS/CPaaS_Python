...
class ServiceDocsCallflowGetSingle(BaseModel):
    """
    ServiceDocsCallflowGetSingle
    """ # noqa: E501
    data: Optional[ServiceCallflowOutputFull] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceCallflowOutputFull.from_dict(obj["data"]) if obj.get("data") is not None else None,
