...
class ServiceVOIPUserAdd2(BaseModel):
    """
    ServiceVOIPUserAdd2
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["call_forward", "call_recording", "caller_id", "do_not_disturb", "email", "enabled", "first_name", "last_name", "music_on_hold", "presence_id", "timezone", "verified"]
