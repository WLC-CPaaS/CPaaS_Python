...
class ServiceVOIPUserAdd2(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["call_forward", "call_recording", "do_not_disturb", "email", "enabled", "first_name", "last_name", "music_on_hold", "presence_id", "timezone", "verified"]
