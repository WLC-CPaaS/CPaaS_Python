...
class ServiceDocsWebhookGetSingle(BaseModel):
    """
    ServiceDocsWebhookGetSingle
    """ # noqa: E501
    data: Optional[ModelAccountWebhook] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ModelAccountWebhook.from_dict(obj["data"]) if obj.get("data") is not None else None,
