...
class ServiceDocsE911AddLocationOutput(BaseModel):
    """
    ServiceDocsE911AddLocationOutput
    """ # noqa: E501
    data: Optional[ServiceE911AddLocationOutput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceE911AddLocationOutput.from_dict(obj["data"]) if obj.get("data") is not None else None,
