...
class ServiceAccountOutputFull(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["call_recording", "caller_id", "do_not_disturb", "enabled", "id", "music_on_hold", "name", "realm", "timezone"]
