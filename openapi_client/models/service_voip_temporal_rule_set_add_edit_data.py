...
class ServiceVOIPTemporalRuleSetAddEditData(BaseModel):
    """
    ServiceVOIPTemporalRuleSetAddEditData
    """ # noqa: E501
    name: Annotated[str, Field(strict=True, max_length=128)]
    temporal_rules: Optional[Annotated[List[StrictStr], Field(min_length=1)]] = None
    __properties: ClassVar[List[str]] = ["name", "temporal_rules"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "temporal_rules": obj.get("temporal_rules")
        })
        return _obj
