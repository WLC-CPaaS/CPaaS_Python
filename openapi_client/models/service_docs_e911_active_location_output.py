...
class ServiceDocsE911ActiveLocationOutput(BaseModel):
    """
    ServiceDocsE911ActiveLocationOutput
    """ # noqa: E501
    data: Optional[ServiceE911ActiveLocationOutput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceE911ActiveLocationOutput.from_dict(obj["data"]) if obj.get("data") is not None else None,
