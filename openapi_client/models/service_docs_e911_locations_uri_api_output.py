...
class ServiceDocsE911LocationsURIApiOutput(BaseModel):
    """
    ServiceDocsE911LocationsURIApiOutput
    """ # noqa: E501
    data: Optional[List[ServiceE911LocationURI]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ServiceE911LocationURI.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
