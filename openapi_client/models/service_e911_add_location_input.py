...
class ServiceE911AddLocationInput(BaseModel):
    ...
    uri: Optional[ServiceE911URIInput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "location": ServiceE911LocationInput.from_dict(obj["location"]) if obj.get("location") is not None else None,
            "uri": ServiceE911URIInput.from_dict(obj["uri"]) if obj.get("uri") is not None else None
        })
        return _obj
