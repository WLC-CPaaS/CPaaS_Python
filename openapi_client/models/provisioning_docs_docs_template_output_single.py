...
class ProvisioningDocsDocsTemplateOutputSingle(BaseModel):
    """
    ProvisioningDocsDocsTemplateOutputSingle
    """ # noqa: E501
    data: Optional[ModelsTemplate] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ModelsTemplate.from_dict(obj["data"]) if obj.get("data") is not None else None,
