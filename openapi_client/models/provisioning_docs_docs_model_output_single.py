...
class ProvisioningDocsDocsModelOutputSingle(BaseModel):
    """
    ProvisioningDocsDocsModelOutputSingle
    """ # noqa: E501
    data: Optional[ModelsModel] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ModelsModel.from_dict(obj["data"]) if obj.get("data") is not None else None,
