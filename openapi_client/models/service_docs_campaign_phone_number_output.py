...
class ServiceDocsCampaignPhoneNumberOutput(BaseModel):
    """
    ServiceDocsCampaignPhoneNumberOutput
    """ # noqa: E501
    data: Optional[ServiceCampaignPhoneNumberOutput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceCampaignPhoneNumberOutput.from_dict(obj["data"]) if obj.get("data") is not None else None,
