...
class ServiceDocsAccountLimit(BaseModel):
    """
    ServiceDocsAccountLimit
    """ # noqa: E501
    data: Optional[ServiceAccountLimitOutput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceAccountLimitOutput.from_dict(obj["data"]) if obj.get("data") is not None else None,
