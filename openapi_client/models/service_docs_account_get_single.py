...
class ServiceDocsAccountGetSingle(BaseModel):
    """
    ServiceDocsAccountGetSingle
    """ # noqa: E501
    data: Optional[ServiceAccountOutputFull] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceAccountOutputFull.from_dict(obj["data"]) if obj.get("data") is not None else None,
