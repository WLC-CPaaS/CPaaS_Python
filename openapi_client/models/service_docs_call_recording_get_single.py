...
class ServiceDocsCallRecordingGetSingle(BaseModel):
    """
    ServiceDocsCallRecordingGetSingle
    """ # noqa: E501
    data: Optional[ServiceCallRecordingOutput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceCallRecordingOutput.from_dict(obj["data"]) if obj.get("data") is not None else None,
