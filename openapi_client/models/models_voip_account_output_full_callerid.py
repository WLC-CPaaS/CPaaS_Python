...
class ModelsVOIPAccountOutputFullCallerid(BaseModel):
    """
    ModelsVOIPAccountOutputFullCallerid
    """ # noqa: E501
    emergency: Optional[ModelsAccountOutputFullCalleridEmergency] = None
    external: Optional[ModelsAccountOutputFullCalleridExternal] = None
    internal: Optional[ModelsAccountOutputFullCalleridInternal] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "emergency": ModelsAccountOutputFullCalleridEmergency.from_dict(obj["emergency"]) if obj.get("emergency") is not None else None,
            "external": ModelsAccountOutputFullCalleridExternal.from_dict(obj["external"]) if obj.get("external") is not None else None,
            "internal": ModelsAccountOutputFullCalleridInternal.from_dict(obj["internal"]) if obj.get("internal") is not None else None
        })
        return _obj
