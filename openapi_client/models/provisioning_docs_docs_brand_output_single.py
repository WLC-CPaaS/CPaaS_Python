...
class ProvisioningDocsDocsBrandOutputSingle(BaseModel):
    """
    ProvisioningDocsDocsBrandOutputSingle
    """ # noqa: E501
    data: Optional[ModelsBrand] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ModelsBrand.from_dict(obj["data"]) if obj.get("data") is not None else None,
