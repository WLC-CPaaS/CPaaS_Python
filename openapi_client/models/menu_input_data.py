...
class MenuInputData(BaseModel):
    """
    MenuInputData
    """ # noqa: E501
    media: Optional[MenuOutputDetailMedia] = Field(default=None, description="The media (prompt) parameters")
    name: Annotated[str, Field(strict=True, max_length=128)] = Field(description="A friendly name for the menu")
    timeout: Optional[Annotated[int, Field(le=60000, strict=True, ge=1)]] = Field(default=None, description="The amount of time (in milliseconds) to wait for the caller to begin entering digits")
    __properties: ClassVar[List[str]] = ["media", "name", "timeout"]
