...
class ModelEventDailySummary(BaseModel):
    """
    ...
    transaction_date: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["account_id", "component", "created_at", "transaction_count", "transaction_date"]
