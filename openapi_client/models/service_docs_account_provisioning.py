...
class ServiceDocsAccountProvisioning(BaseModel):
    """
    ServiceDocsAccountProvisioning
    """ # noqa: E501
    data: Optional[ModelAccountProvisioning] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ModelAccountProvisioning.from_dict(obj["data"]) if obj.get("data") is not None else None,
