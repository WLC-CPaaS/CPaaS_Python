...
class ServiceQueueRecipientOutputFullRecipient(BaseModel):
    """
    ServiceQueueRecipientOutputFullRecipient
    """ # noqa: E501
    features: Optional[ServiceQueueRecipientOutputFullFeatures] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "features": ServiceQueueRecipientOutputFullFeatures.from_dict(obj["features"]) if obj.get("features") is not None else None
        })
        return _obj
