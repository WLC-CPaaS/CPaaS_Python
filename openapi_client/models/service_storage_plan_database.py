...
class ServiceStoragePlanDatabase(BaseModel):
    """
    ServiceStoragePlanDatabase
    """ # noqa: E501
    attachments: Optional[ServiceStoragePlanDatabaseAttachment] = None
    connection: Optional[StrictStr] = None
    database: Optional[ServiceStoragePlanDatabaseProperties] = None
    types: Optional[ServiceStoragePlanDatabaseTypes] = None
    __properties: ClassVar[List[str]] = ["attachments", "connection", "database", "types"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attachments": ServiceStoragePlanDatabaseAttachment.from_dict(obj["attachments"]) if obj.get("attachments") is not None else None,
            "connection": obj.get("connection"),
            "database": ServiceStoragePlanDatabaseProperties.from_dict(obj["database"]) if obj.get("database") is not None else None,
            "types": ServiceStoragePlanDatabaseTypes.from_dict(obj["types"]) if obj.get("types") is not None else None
        })
        return _obj
