...
class ServiceDeviceOutputFullMedia(BaseModel):
    """
    ServiceDeviceOutputFullMedia
    """ # noqa: E501
    audio: Optional[ServiceDeviceOutputFullMediaAudio] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "audio": ServiceDeviceOutputFullMediaAudio.from_dict(obj["audio"]) if obj.get("audio") is not None else None
        })
        return _obj
