...
class ServiceDocsStorageGet(BaseModel):
    """
    ServiceDocsStorageGet
    """ # noqa: E501
    data: Optional[ServiceStorageOutput] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ServiceStorageOutput.from_dict(obj["data"]) if obj.get("data") is not None else None,
