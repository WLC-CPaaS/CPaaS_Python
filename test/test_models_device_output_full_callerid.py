...
class TestModelsDeviceOutputFullCallerid(unittest.TestCase):
    """ModelsDeviceOutputFullCallerid unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModelsDeviceOutputFullCallerid:
        """Test ModelsDeviceOutputFullCallerid
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelsDeviceOutputFullCallerid`
        """
        model = ModelsDeviceOutputFullCallerid()
        if include_optional:
            return ModelsDeviceOutputFullCallerid(
    ...
    def testModelsDeviceOutputFullCallerid(self):
        """Test ModelsDeviceOutputFullCallerid"""
