...
class TestServiceDocsVoicemailGetSingle(unittest.TestCase):
    """ServiceDocsVoicemailGetSingle unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceDocsVoicemailGetSingle:
        """Test ServiceDocsVoicemailGetSingle
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceDocsVoicemailGetSingle`
        """
    ...
    def testServiceDocsVoicemailGetSingle(self):
        """Test ServiceDocsVoicemailGetSingle"""
