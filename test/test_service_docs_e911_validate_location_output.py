...
class TestServiceDocsE911ValidateLocationOutput(unittest.TestCase):
    """ServiceDocsE911ValidateLocationOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceDocsE911ValidateLocationOutput:
        """Test ServiceDocsE911ValidateLocationOutput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceDocsE911ValidateLocationOutput`
        """
        model = ServiceDocsE911ValidateLocationOutput()
        if include_optional:
    ...
    def testServiceDocsE911ValidateLocationOutput(self):
        """Test ServiceDocsE911ValidateLocationOutput"""
