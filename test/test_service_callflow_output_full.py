...
class TestServiceCallflowOutputFull(unittest.TestCase):
    """ServiceCallflowOutputFull unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceCallflowOutputFull:
        """Test ServiceCallflowOutputFull
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceCallflowOutputFull`
        """
        model = ServiceCallflowOutputFull()
        if include_optional:
    ...
    def testServiceCallflowOutputFull(self):
        """Test ServiceCallflowOutputFull"""
