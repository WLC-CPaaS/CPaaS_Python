...
class TestServiceDocsUserGetAll(unittest.TestCase):
    """ServiceDocsUserGetAll unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceDocsUserGetAll:
        """Test ServiceDocsUserGetAll
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceDocsUserGetAll`
        """
        model = ServiceDocsUserGetAll()
        if include_optional:
            return ServiceDocsUserGetAll(
                data = [
                    openapi_client.models.service/user_output_short.service.UserOutputShort(
    ...
    def testServiceDocsUserGetAll(self):
        """Test ServiceDocsUserGetAll"""
