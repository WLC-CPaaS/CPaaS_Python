...
class TestServiceDocsE911AddLocationOutput(unittest.TestCase):
    """ServiceDocsE911AddLocationOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceDocsE911AddLocationOutput:
        """Test ServiceDocsE911AddLocationOutput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceDocsE911AddLocationOutput`
        """
        model = ServiceDocsE911AddLocationOutput()
        if include_optional:
    ...
    def testServiceDocsE911AddLocationOutput(self):
        """Test ServiceDocsE911AddLocationOutput"""
