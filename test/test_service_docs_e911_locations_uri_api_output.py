...
class TestServiceDocsE911LocationsURIApiOutput(unittest.TestCase):
    """ServiceDocsE911LocationsURIApiOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceDocsE911LocationsURIApiOutput:
        """Test ServiceDocsE911LocationsURIApiOutput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceDocsE911LocationsURIApiOutput`
        """
        model = ServiceDocsE911LocationsURIApiOutput()
        if include_optional:
    ...
    def testServiceDocsE911LocationsURIApiOutput(self):
        """Test ServiceDocsE911LocationsURIApiOutput"""
