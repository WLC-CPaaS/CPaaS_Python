...
class TestServiceAccountOutput(unittest.TestCase):
    """ServiceAccountOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceAccountOutput:
        """Test ServiceAccountOutput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceAccountOutput`
        """
        model = ServiceAccountOutput()
        if include_optional:
    ...
    def testServiceAccountOutput(self):
        """Test ServiceAccountOutput"""
